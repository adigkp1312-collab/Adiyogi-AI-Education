...
var hasPermission = (input) => {
  ...
  for (const role2 of roles) if ((_f = (_e = acRoles[role2]) == null ? void 0 : _e.authorize(input.permissions)) == null ? void 0 : _f.success) return true;
  return false;
};
  ...
  return {
    ...
    getActions: ($fetch, _) => {
      return { oneTap: async (opts, fetchOptions) => {
        ...
        if (opts == null ? void 0 : opts.button) {
          ...
          (_b = window.google) == null ? void 0 : _b.accounts.id.renderButton(container, opts.button.config ?? { type: "icon" });
          return;
        }
        ...
        try {
          ...
          await new Promise((resolve, reject) => {
            ...
            const maxAttempts = ((_b2 = options.promptOptions) == null ? void 0 : _b2.maxAttempts) ?? 5;
            ...
            const handlePrompt = (attempt) => {
              ...
              (_a3 = window.google) == null ? void 0 : _a3.accounts.id.prompt((notification) => {
                ...
                if (notification.isDismissedMoment && notification.isDismissedMoment()) {
                  const reason = (_a4 = notification.getDismissedReason) == null ? void 0 : _a4.call(notification);
                  if (noRetryReasons.dismissed.includes(reason)) {
                    (_b3 = opts == null ? void 0 : opts.onPromptNotification) == null ? void 0 : _b3.call(opts, notification);
                    resolve();
                    return;
                  }
                  if (attempt < maxAttempts) {
                    ...
                    (_c2 = opts == null ? void 0 : opts.onPromptNotification) == null ? void 0 : _c2.call(opts, notification);
                    resolve();
                  }
                } else if (notification.isSkippedMoment && notification.isSkippedMoment()) {
                  const reason = (_d = notification.getSkippedReason) == null ? void 0 : _d.call(notification);
                  if (!reason || noRetryReasons.skipped.includes(reason)) {
                    (_e = opts == null ? void 0 : opts.onPromptNotification) == null ? void 0 : _e.call(opts, notification);
                    resolve();
                    return;
                  }
                  if (attempt < maxAttempts) {
                    ...
                    (_f = opts == null ? void 0 : opts.onPromptNotification) == null ? void 0 : _f.call(opts, notification);
                    resolve();
                  }
                } else if (notification.isNotDisplayed && notification.isNotDisplayed()) {
                  (_g = opts == null ? void 0 : opts.onPromptNotification) == null ? void 0 : _g.call(opts, notification);
                  resolve();
                }
              });
            };
...
var hasPermissionFn = (input, acRoles) => {
  ...
  for (const role2 of roles) if ((_b = (_a = acRoles[role2]) == null ? void 0 : _a.authorize(input.permissions)) == null ? void 0 : _b.success) return true;
  return false;
};
